...
function createRestaurantHTML(restaurant) {
  ...
  image.className = 'restaurant__image lazy-loading';
  image.dataset.srcset = `${imageName}-small.webp 400w, ${imageName}.webp 800w`;
  image.alt = [
    'restaurant',
    restaurant.name,
  ...
  // picture.className = 'restaurant__image';
  // li.appendChild(picture);

  // const source = document.createElement('source');
  // const url = DBHelper.imageUrlForRestaurant(restaurant);
  // const filename = url.substring(0, url.lastIndexOf('.'));
  // source.type = 'image/webp';
  // source.srcset = `${filename}-small.webp 400w, ${filename}.webp 800w`;
